...
function makeComputerMove() {
	...
	const SelectRandomButton = AvailableButtons[Math.floor(Math.random()*AvailableButtons.length)]
	SelectRandomButton.innerHTML ='O'
	SelectRandomButton.setAttribute('class','o')
	SelectRandomButton.setAttribute('disabled','true')
	switchTurn();
	// TODO: Complete the function
}